---
title: Linear regression, prediction, and weighting
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Linear regression and linear weighting}
...
well as the Rhat convergence diagnostic.
...
an object of class `draws`. Methods for the generic functions `summary`, `plot`, `predict`, `residuals` and `fitted` are currently implemented for this class.
...
[`predict`](../html/predict.draws.html) is used to generate
